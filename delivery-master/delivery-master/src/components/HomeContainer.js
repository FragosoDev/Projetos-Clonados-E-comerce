  ...
  return (
    ...
    justify-center gap-6'>
      ...
      <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>
        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Rem aliquam facere
         ea cupiditate adipisci porro voluptatem quas alias incidunt sunt, architecto 
         at dolorem, minima velit ducimus facilis. Doloribus, ipsa ducimus!
      </p>
      <button 
        type='button' 
        className='bg-gradient-to-br from-orange-400 to-orange-500
        w-full md:auto px-4 py-2 rounded-lg hover:shadow-lg transition-all ease-in-out duration-100'>
        Order Now
      </button>
    </div>
    ...
    <div className='py-2 flex-1 flex items-center relative'>
      ...
      items-center justify-center px-1 lg:px-12 py-2 gap-4 flex-wrap'>
