      ...
      <div className='hidden md:flex w-full h-full'>
        ...
        <motion.img 
          ...
          className="w-10 min-w-[40px] h-10 min-h-[40px] drop-shadow-xl
           ml-6 cursor-pointer rounded-full" 
          alt='ava'
          onClick={login}
          />
          {
            isMenu && (
              <motion.div 
                ...
                className="w-40 flex flex-col bg-gray-50 shadow-xl rounded-lg 
       ...
       w-full h-full'>
        ...
        <motion.img 
          ...
          <ul className='flex flex-col '>
              <li className='text-base text-textColor hover:text-headingColor duration-100 
              transition-all ease-in-out cursor-pointer px-4 py-2 hover:bg-slate-100'
              onClick={() => setIsMenu(false)}>
                Home
              </li>
              <li className='text-base text-textColor hover:text-headingColor duration-100 
          ...
          <p 
            ...
            transition-all justify-center bg-gray-200 duration-100 ease-in-out text-textColor 
            text-base"
            onClick={logout}  
            >
              Logout<MdLogout />
