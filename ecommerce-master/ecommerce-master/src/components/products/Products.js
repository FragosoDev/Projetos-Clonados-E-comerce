  ...
  return (
    <>
      <div className='buttons'>
        ...
        <button className='btn' type='submit' onClick={() => filterProduct("men's clothing")}>Man's</button>
        <button className='btn' type='submit' onClick={() => filterProduct("women's clothing")}>Woman's</button>
